        ...
        public List<Arrow> parse(String filePath)
        {
            ...
            do
            {
                for (int i = 0; i < mesureList[mesureId].size; i++)
                {
                    ...
                    if (text.Substring(0, 1).Equals("1") || text.Substring(0, 1).Equals("2")) ArrowList.Add(new Arrow(ArrowColors.Blue, Rows.Row1, time));
                    if (text.Substring(1, 1).Equals("1") || text.Substring(1, 1).Equals("2")) ArrowList.Add(new Arrow(ArrowColors.Blue, Rows.Row2, time));
                    if (text.Substring(2, 1).Equals("1") || text.Substring(2, 1).Equals("2")) ArrowList.Add(new Arrow(ArrowColors.Blue, Rows.Row3, time));
                    if (text.Substring(3, 1).Equals("1") || text.Substring(3, 1).Equals("2")) ArrowList.Add(new Arrow(ArrowColors.Blue, Rows.Row4, time));
